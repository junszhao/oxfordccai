...
The [CHAI (Designing for Children's Agency in AI) framework](https://github.com/junszhao/ethical-design)  provides a conceptual framework that helps design teams reason explicitly about children's agency during the design process.
...
The CHAI framework materials, including workshop templates, the agency mapping matrix, and case study examples, are openly available at: [https://github.com/junszhao/ethical-design](https://github.com/junszhao/ethical-design).


A full documentation of our evaluation of the framework can be found in our [arXiv paper here](https://arxiv.org/abs/2603.26523).
